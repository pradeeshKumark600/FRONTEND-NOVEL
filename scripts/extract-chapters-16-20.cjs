...
/**
 * Extract chapters 16-20 from Novel 2 and save them as JSON files
 */
function extractChapters() {
  const chaptersToExtract = [16, 17, 18, 19, 20];

  console.log('📖 Extracting Chapters 16-20 from Novel 2...\n');
